package Catmandu::Store::Koha::Biblio;

use Catmandu::Sane;
use Moo;
use Catmandu::Store::Koha::Biblio::Bag;

with 'Catmandu::Store';

=head1 NAME

Catmandu::Store::Koha::Biblio - A searchable store of the bibliographic records in Koha
...
=head1 SYNOPSIS
    ...
    use Catmandu::Store::Koha::Biblio;

    my $store = Catmandu::Store::Koha::Biblio->new();
...
sub drop {
    ...
    Catmandu::NotImplemented->throw('drop not implemented');
}
