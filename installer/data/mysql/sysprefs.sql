...
INSERT INTO `systempreferences` (variable,value,explanation,options,type) VALUES ('AuthoritiesLog','1','If ON, log edit/create/delete actions on authorities.',NULL,'YesNo');
...
INSERT INTO systempreferences (variable,value,explanation,options,type) VALUES ('shibbolethAuthentication','','','Enable or disable Shibboleth authentication','YesNo');
INSERT INTO systempreferences (variable,value,explanation,options,type) VALUES ('shibbolethLoginAttribute','','','Which shibboleth user attribute should be used to match koha user login?','');
